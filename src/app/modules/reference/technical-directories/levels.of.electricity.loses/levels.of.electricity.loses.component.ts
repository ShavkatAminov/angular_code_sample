...
export class LevelsOfElectricityLosesComponent extends BasicReferencePage {
    columnDefs: ColDef[] = [
            ...
            field: 'coatoBranches.code', headerName: 'REFERENCE.COATO', minWidth: 150},
        {
            ...
            field: 'standardValues.voltageLevelNetwork', headerName: 'REFERENCE.NETWORK', minWidth: 150},
        ...
        {field: 'createdAt', headerName: 'GENERAL.CREATED_AT', type: 'date'},
        {field: 'updatedAt', headerName: 'GENERAL.UPDATED_AT', type: 'date'},
        {field: 'createdByName', headerName: 'GENERAL.CREATED_BY', type: 'user'},
        {field: 'updatedByName', headerName: 'GENERAL.UPDATED_BY', type: 'user'}
    ];
